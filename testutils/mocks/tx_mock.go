...
//go:generate minimock -i github.com/gippuss/datagate/testutils.Tx -o tx_mock.go -n TxMock -p mocks
...
// TxMock implements mm_testutils.Tx
type TxMock struct {
	t          minimock.Tester
...
// NewTxMock returns a mock for mm_testutils.Tx
...
// Begin implements mm_testutils.Tx
...
// Commit implements mm_testutils.Tx
...
// Conn implements mm_testutils.Tx
...
// CopyFrom implements mm_testutils.Tx
...
// Exec implements mm_testutils.Tx
...
// LargeObjects implements mm_testutils.Tx
...
// Prepare implements mm_testutils.Tx
...
func (mmQuery *mTxMockQuery) Set(f func(ctx context.Context, sql string, args ...any) (r1 pgx.Rows, err error)) *TxMock {
	if mmQuery.defaultExpectation != nil {
...
// Query implements mm_testutils.Tx
func (mmQuery *TxMock) Query(ctx context.Context, sql string, args ...any) (r1 pgx.Rows, err error) {
...
func (mmQueryRow *mTxMockQueryRow) Set(f func(ctx context.Context, sql string, args ...any) (r1 pgx.Row)) *TxMock {
	if mmQueryRow.defaultExpectation != nil {
...
// QueryRow implements mm_testutils.Tx
func (mmQueryRow *TxMock) QueryRow(ctx context.Context, sql string, args ...any) (r1 pgx.Row) {
...
// Rollback implements mm_testutils.Tx
...
// SendBatch implements mm_testutils.Tx
